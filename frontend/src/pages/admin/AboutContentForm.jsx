...
const AboutContentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await aboutContentAPI.updateContent(id, submitData)
        alert('Content updated successfully')
      } else {
        await aboutContentAPI.createContent(submitData)
        alert('Content created successfully')
      }
      navigate('/admin/about-content')
    } catch (error) {
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          {isEdit ? 'Update about page content section' : 'Add new about page content section'}
        </p>
      </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Enter JSON content for flexible data (e.g., paragraphs array, stats values, etc.)
            </p>
          </div>
          ...
          <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
            <button
              type="button"
              onClick={() => navigate('/admin/about-content')}
