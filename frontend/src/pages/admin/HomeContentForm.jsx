...
const HomeContentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await homeContentAPI.updateContent(id, submitData)
        alert('Content updated successfully')
      } else {
        await homeContentAPI.createContent(submitData)
    ...
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">
          {isEdit ? 'Edit Home Content' : 'Create Home Content'}
        </h1>
        <p className="mt-2 text-gray-600">
          {isEdit ? 'Update home page content section' : 'Add new home page content section'}
        </p>
      </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Enter JSON content for flexible data (e.g., features array, CTA links, etc.)
            </p>
          </div>
