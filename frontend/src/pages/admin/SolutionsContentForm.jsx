...
const SolutionsContentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await solutionsContentAPI.updateContent(id, submitData)
        alert('Content updated successfully')
      } else {
        await solutionsContentAPI.createContent(submitData)
        alert('Content created successfully')
      }
      navigate('/admin/solutions-content')
    } catch (error) {
    ...
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">
          {isEdit ? 'Edit Solutions Content' : 'Create Solutions Content'}
        </h1>
        <p className="mt-2 text-gray-600">
          {isEdit ? 'Update solutions page content section' : 'Add new solutions page content section'}
        </p>
      </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Enter JSON content for flexible data (e.g., features array, results array, etc.)
            </p>
          </div>
          ...
          <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
            <button
              type="button"
              onClick={() => navigate('/admin/solutions-content')}
